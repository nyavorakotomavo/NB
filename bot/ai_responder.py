...
def _detecter_intention_rapide(message: str) -> str:
    ...
    mots_pro = ["abonner", "prix", "tarif", "payer", "offre", "produit", "service", "live", "formation", "concurren", "avantage", "différence", "contenu", "publiez", "page"]
    mots_stop = ["au revoir", "à plus", "ciao", "bye", "non", "je sais pas", "ok", "d'accord"]
